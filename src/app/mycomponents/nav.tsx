...
const Navbar = () => {
  ...
  return (
    <nav className=" bg-white shadow  text-3xl  fixed w-screen mt-0   active:bg-transparent  dark:bg-black z-20">
        ...
        <div className="lg:flex lg:items-center lg:justify-between">
          ...
          <div className={`${isOpen ? 'block' : 'hidden'} absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center`}>
            <div className="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
              ...
              <Link href={"/doubts"} onClick={toggleNavbar} className="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">ExploreDoubts</Link>
            ...
            <div className="flex items-center mt-4 lg:mt-0 ">
              ...
              <button type="button" className="flex items-center focus:outline-none" onClick={toggleNavbar} aria-label="toggle profile dropdown">
                  ...
                  <Link href={"/user/dashboard"} className='w-full h-full"  font-bold  dark:text-white text-blue-500 text-center p-12 text-4xl'>Me</Link>
